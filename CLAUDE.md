...
```mermaid
graph TD
  264a8cb0["ERC-721 NFT"]
  cf0edd37["Frontend"]
  9b5db22e["Wallet Auth"]
  264a8cb0 --> cf0edd37
  cf0edd37 --> 9b5db22e
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--264a8cb0.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--cf0edd37.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--9b5db22e.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--264a8cb0.md)
- [Frontend](.nskills/components/frontend-scaffold--cf0edd37.md)
- [Wallet Auth](.nskills/components/wallet-auth--9b5db22e.md)
